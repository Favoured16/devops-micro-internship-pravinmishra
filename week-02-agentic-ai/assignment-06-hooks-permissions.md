...
![alt text](<screenshots/Screenshot showing settings.json` open in VS Code with full permissions config.-1.png>)
---
...
![alt text](<screenshots/Screenshot showing settings.json showing UserPromptSubmit hook.png>)
---
...
![alt text](<screenshots/Screenshot showing full settings.json with permissions and hooks.png>)
---
...
![alt text](<screenshots/Screenshot showing Blocked prompt due to UserPromptSubmit hook.png>)
---
...
![alt text](<screenshots/Screenshot showing PreToolUse hook blocking terraform destroy.png>)
---
...
![alt text](<screenshots/UserPromptSubmit hook blocking the destructive prompt.png>)
---
...
![alt text](<screenshots/PreToolUse hook blocking terraform destroy.png>)
---
...
![alt text](<screenshots/Claude running terraform validate successfully.png>)

#### Screenshot 9 — `.claude/deploy.log` showing the logged command
![alt text](<screenshots/claude deploy.log showing the logged command-1.png>)
---
