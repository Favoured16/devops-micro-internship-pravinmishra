...
![alt text](<screenshots/Screenshot showing html, no claude.md.png>)
...
![alt text](<screenshots/Screenshot showing autogenerated claude with init.png>)
...
![alt text](<screenshots/Screenshot showing updated claude.md.png>)
---
...
![alt text](<screenshots/Screenshot showing S3, cloud and terraform.png>)

---

#### Screenshot 5 — Claude refusing or warning against adding React because of the "No JavaScript" convention defined in CLAUDE.md

![alt text](<screenshots/Screenshot showing no javascript react-1.png>)
---
...
![alt text](<screenshots/Screenshot showing CLAUDE.md  visible in the repository.png>)
---
