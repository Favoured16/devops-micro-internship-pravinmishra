...
![alt text](<screenshots/Output of git status and git branch showing a clean status and the default branch .png>)
...
![alt text](<screenshots/Output of git checkout b feature contact page and git branch.png>)
...
![alt text](<screenshots/Output of ls showing contact html.png>)

---

#### Screenshot 4 — Output of `git commit`

![alt text](<screenshots/Output of git commit 03.png>)

---

#### Screenshot 5 — Output of `git log --oneline -3` showing the new commit

![alt text](<screenshots/Output of git log oneline  showing the new commit.png>)
...
![alt text](<screenshots/Output of git status showing index html as modified before staging.png>)

---

#### Screenshot 7 — Output of `git commit`

![alt text](<screenshots/output of git committ.png>)

---

#### Screenshot 8 — Browser showing the Contact Page link on the homepage while on `feature/contact-page`

![alt text](<screenshots/Browser showing the Contact Page link on the homepage while on feature contact page.png>)
...
![alt text](<screenshots/Terminal showing the checkout and ls output proving contact html is absent.png>)

---

#### Screenshot 10 — Browser showing the homepage on the default branch with no Contact Page link

1[alt text](<screenshots/Browser showing the homepage on the default branch with no Contact Page link.png>)
...
![alt text](<screenshots/Output of git merge feature contact page.png>)

---

#### Screenshot 12 — Output of `ls` showing `contact.html` after the merge

![alt text](<screenshots/Output of ls showing contact html after the merge.png>)

---

#### Screenshot 13 — Browser showing the Contact page opened from the homepage link on the default branch

![alt text](<screenshots/Browser showing the Contact page opened from the homepage link.png>)
...
![alt text](<screenshots/Full output of git log oneline graph decorate all.png>)
...
![alt text](<screenshots/Output showing feature contact page deleted and no longer listed.png>)
