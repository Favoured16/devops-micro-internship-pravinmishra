...
[alt text](<Output of git status and git branch showing a clean status and the default branch .png>)
...
[alt text](<Output of git checkout b feature contact page and git branch.png>)
...
[alt text](<Output of git commit 03.png>)

---

#### Screenshot 5 — Output of `git log --oneline -3` showing the new commit

[alt text](<Output of git log oneline  showing the new commit.png>)
...
[alt text](<Output of git status showing index html as modified before staging.png>)

---

#### Screenshot 7 — Output of `git commit`

[alt text](<output of git committ.png>)

---

#### Screenshot 8 — Browser showing the Contact Page link on the homepage while on `feature/contact-page`

[alt text](<Browser showing the Contact Page link on the homepage while on feature contact page.png>)
...
[alt text](<Browser showing the Contact page opened from the homepage link.png>)
