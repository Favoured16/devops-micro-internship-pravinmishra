...
![alt text](<screenshots/Output of ip a.png>).

---

#### Screenshot 3 — Output of `sudo ss -tulpen`

![alt text](<screenshots/Output of sudo ss tulpen.png>).

---

#### Screenshot 4 — Output of `sudo ufw status`

![alt text](<screenshots/Output of sudo ufw status.png>)
---
...
![alt text](<screenshots/Output of systemctl status nginx no-pager.png>)
---

#### Screenshot 2 — Output of `sudo nginx -t`


![alt text](<screenshots/Output of sudo nginx t.png>)
---

#### Screenshot 3 — Output of `sudo ss -lptn '( sport = :80 )'`


![alt text](<screenshots/Output of sudo ss lptn ( sport = 80 ).png>)
---
...
![alt text](<screenshots/Output of sudo tail -n 30 var log nginx access.log.png>)
---

#### Screenshot 2 — Output of `sudo tail -n 30 /var/log/nginx/error.log`


![alt text](<screenshots/Output of sudo tail n 30 var log nginx error log.png>)
---

#### Screenshot 3 — Output of `sudo journalctl -u nginx --no-pager -n 50`


![alt text](<screenshots/Output of sudo journal ctl u nginx no pager n 50.png>)
---
...
![alt text](<screenshots/Output of Uptime.png>)
---

#### Screenshot 2 — Output of `free -h`


![alt text](<screenshots/Output Of free -h.png>)
---

#### Screenshot 3 — Output of `df -h`


![alt text](<screenshots/Output Of df -h.png>)
---

#### Screenshot 4 — Output of `sudo du -sh /var/* | sort -h`


![alt text](<screenshots/Output Of sudo du sh var  sort -h.png>)
---
...
![alt text](<screenshots/Output of ls lah var www html  head n 20.png>)
---

#### Screenshot 2 — Output of `grep -R "Deployed by" -n /var/www/html 2>/dev/null | head`


![alt text](<screenshots/Output of grep R Deployed by n var www html 2 dev null  head.png>)
---

#### Screenshot 3 — Output of `grep -n "try_files" /etc/nginx/sites-available/default`


![alt text](<screenshots/Output of grep n try files etc nginx sites available default-1.png>)
---
...
![alt text](<screenshots/Output of sudo nginx t showing the syntax error broken Config.png>)
---

#### Screenshot 2 — Output of `sudo nginx -t` showing syntax ok (fixed config)


![alt text](<screenshots/Output of sudo nginx t showing syntax ok fixed config-1.png>)
---

#### Screenshot 3 — Output of `curl -I http://<public-ip>` confirming recovery (200 OK)


![alt text](<screenshots/Output Of curl I public ip confirming recovery 200 OK.png>)
---
...
![alt text](<screenshots/Output of `curl -I public-ip showing failure non-200 response.png>)
---
