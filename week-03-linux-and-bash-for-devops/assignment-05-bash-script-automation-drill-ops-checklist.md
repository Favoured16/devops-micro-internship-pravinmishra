...
![alt text](<screenshots/Output of echo $SHELL and bash -version.png>)
---

#### Screenshot 2 — Output of `pwd` and `ls -lah` showing the scripts directory

![alt text](<screenshots/Output of pwd and ls  lah showing the scripts directory.png>)
---
...
![alt text](<screenshots/My First Bash script.png>)
---

#### Screenshot 2 — Output of `./first-script.sh`

![alt text](<screenshots/Output of First-script.sh.png>)
...
![alt text](<screenshots/Output of `ls -l first-script.sh` showing executable permission.png>)
---
...
![alt text](<screenshots/Content of user-info.sh.png>)
---

#### Screenshot 2 — Output of `./user-info.sh`


![alt text](<screenshots/Output of user-info.sh.png>)
---
...
![alt text](<screenshots/Content Of tools checklist sh.png>)
---

#### Screenshot 2 — Output of `./tools-checklist.sh`


![alt text](<screenshots/Output of tools checklist sh.png>)
---
...
![alt text](<screenshots/Content Of counter sh.png>)
---

#### Screenshot 2 — Output of `./counter.sh`

![alt text](<screenshots/Output of counter sh.png>)
---
...
!![alt text](<screenshots/Output of ls lah test folder-1.png>)
---

#### Screenshot 2 — Content of `file-check.sh`


![alt text](<screenshots/Content Of file check sh.png>)
---

#### Screenshot 3 — Output of `./file-check.sh`


![alt text](<screenshots/Output Of file check sh.png>)
---
...
![alt text](<screenshots/Content Of core check.sh With score=85.png>)
---

#### Screenshot 2 — Output showing `Result: Pass`


![alt text](<screenshots/Output showing Result Pass.png>)
---

#### Screenshot 3 — Content of `score-check.sh` with `score=55`


![alt text](<screenshots/Content Of core check.sh With score=85-1.png>)
---

#### Screenshot 4 — Output showing `Result: Retry`


![alt text](<screenshots/Output showing Result Retry.png>)
---
...
![alt text](<screenshots/Content Of final automation sh.png>)
---

#### Screenshot 2 — Output of `./final-automation.sh`


![alt text](<screenshots/Output Of final automation sh.png>)
---

#### Screenshot 3 — Output of `ls -lah` showing all created scripts


![alt text](<screenshots/Output of ls lah showing all created scripts.png>)
---
...
!![alt text](<screenshots/Published LinkedIn post.png>)
---
