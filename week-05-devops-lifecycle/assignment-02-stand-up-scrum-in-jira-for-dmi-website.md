...
![alt text](<Space confirmation .png>)
...
![alt text](<Backlog showing the Epic panel enabled.png>)
...
![alt text](<Backlog showing the Epic and all six Stories.png>)

---

#### Screenshot 4 — One opened Story showing its Story point estimate, acceptance criteria, and label

![alt text](<One opened Story showing its Story point estimate and label.png>)
![alt text](<One opened Story showing its acceptance criteria.png>)
---
...
![alt text](<Backlog showing labels.png>)
![alt text](<Backlog s2  showing labels.png>)
...
![alt text](<Sprint 1 before starting, showing the selected Stories.png>)

---

#### Screenshot 9 — Active Sprint board showing the started Sprint and Sprint Goal
![alt text](<Active Sprint board showing started Sprint and Sprint Goal.png>)
...
![alt text](<Filter for label  frontend showing the filtered results.png>)
