...
![alt text](<Sprint 1 created with the Story inside.png>)
...
![alt text](<footer with Public ec2 url .png>)
...
![alt text](<Code editor showing the footer and date logic.png>)

---

#### Screenshot 8 — EC2 browser view showing the updated footer with the current date

![alt text](<EC2 browser view showing the updated footer and current date.png>)
...
![alt text](<Desktop EC2 view showing the polished footer-2.png>)

---

#### Screenshot 12 — Mobile responsive view showing the footer remains readable

![alt text](<Mobile responsive view showing the footer-1.png>)
...
![alt text](<EC2 browser view showing Start your DevOps Journey here.png>)
...
![alt text](<Final EC2 footer browserr.png>)
![alt text](<Final EC2 footer browser .png>)
...
https://drive.google.com/file/d/1xnnafC7Hxk0JedY7xCenYyxDVQoTsqas/view?usp=sharing
