...
![alt text](<Create project screen.png>)
...
PO (Product Owner): Responsible for deciding what has the most value and should be prioritized in the backlog
...
Dev Lead: Responsible for what gets built 

DevOps Lead: Responsible for how it gets shipped
---
...
![alt text](<Jira Create project screen-1.png>)
...
![alt text](<Backlog showing the Epic panel with Epic visible.png>)
...
![alt text](<Backlog showing the Epic and at least six Stories.png>)

---

#### Screenshot 5 — One Story opened showing its Story Points and acceptance criteria filled in

![alt text](<One Story opened showing its Story Points.png>)
...
![alt text](<Backlog showing Story Points visible.png>)
...
![alt text](<Sprint 1 with the selected Stories.png>)
...
![alt text](<Burndown Chart page opened.png>)
...
![alt text](<Git commit output .png>)

---

#### Screenshot 12 — Live URL in the browser showing the UI change, with the URL visible

![alt text](<Live URL in the browser showing the UI change-1.png>)
...
`https://lnkd.in/p/etfxTP5p`

---

#### Screenshot 14 — Published LinkedIn post

![alt text](<Published LinkedIn post for gotta job.png>)
